...
var GLTFWriter = class {
	constructor() {
		...
		this.json = { asset: {
			version: "2.0",
			generator: "THREE.GLTFExporter r185"
		} };
		this.cache = {
	...
	*/
	async processMaterialAsync(material, geometry) {
		...
		if (material.normalMap) {
			...
			if (flipX || flipY) normalMap = await this.buildNormalMapTextureAsync(material.normalMap, flipX, flipY);
			const normalMapDef = {
