...
var fieldTypes = {};
for (const key in fieldTypeNames) if (fieldTypeNames.hasOwnProperty(key)) fieldTypes[fieldTypeNames[key]] = parseInt(key, 10);
...
var geoKeys = {};
for (const key in geoKeyNames) if (geoKeyNames.hasOwnProperty(key)) geoKeys[geoKeyNames[key]] = parseInt(key, 10);
//#endregion
export { fieldTagNames as a, fieldTypes as c, photometricInterpretations as d, arrayFields as i, geoKeyNames as l, LercAddCompression as n, fieldTagTypes as o, LercParameters as r, fieldTypeNames as s, ExtraSamplesValues as t, globals_exports as u };
